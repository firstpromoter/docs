...
# Including fpr.js
 On your first promoter dashboard, under the getting started > Quick setup section, you are provided with some scripts which are to be added to your website. It is ideal that the script is added globally on the HEAD section of every marketing or public page of your website.


Using the scripts provided in the Getting started > Quick setup section which look like the below
...
This method is used primarily to send the referral details to first promoter.It takes as its payload the email of the referral/lead
