...
FirstPromoter is a powerful solution for implementing affiliate marketing on your website. It allows affiliates to market or share your product with prospective customers and earn commissions on resulting purchases.
...
## Referral Tracking.
Referral tracking occurs when a lead is captured on your website and sent to FirstPromoter after they sign up or fill out a form. This is achieved via the referral tracking script/API, which requires you to send the referral email address or UID to FirstPromoter. 
