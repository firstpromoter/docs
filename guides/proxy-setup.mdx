...
description: 'FirstPromoter Proxy Integration Guide for Bypassing Ad Blockers'
---
...
3. Download the tracking scripts from <a download  href="https://raw.githubusercontent.com/firstpromoter/docs/refs/heads/main/downloadables/fpr-prox.js">here (Click here) </a> and add it to your main website's public directory.
...
4. Download the tracking scripts from <a download  href="https://raw.githubusercontent.com/firstpromoter/docs/refs/heads/main/downloadables/fpr-prox.js">here (Click here) </a> and add it to your main website's public directory.
This will allow it to be fetched from your website. You can change the name of the file to anything but remember to rename it in the main tracking code below.
...
The contents of your file should look like the following:
...
3. Download the FirstPromoter scripts from <a download  href="https://raw.githubusercontent.com/firstpromoter/docs/refs/heads/main/downloadables/fpr-prox.js">here (Click here) </a> and add it to your main website's public directory.
This will allow it to be fetched from your website.
