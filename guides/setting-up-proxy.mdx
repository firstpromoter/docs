...
<img height="200" className="block dark:hidden" noZoom src="/images/adblocker.png" />
<img height="200" className="hidden dark:block" noZoom src="/images/adblocker-dark.png" />
...
3. Download the tracking scripts from <a download  href="/scripts/fpr-prox.js">here (Click here) </a> and add it to your main websites public directory.
...
const SCRIPT_PATH = "/tscript"; // you can change this to something else
...
4. Download the tracking scripts from <a download  href="/scripts/fpr-prox.js">here (Click here) </a> and add it to your main websites public directory.
This will allow it to be fetched from your website. You can change the name of the file to anything but remember to rename it in the main tracking code below.
...
3. Download the FirstPromoter scripts from <a download  href="/scripts/fpr-prox.js">here (Click here) </a> and add it to your main websites public directory.
...
3. Download the FirstPromoter scripts from from <a download  href="/scripts/fpr-prox.js">here (Click here) </a> and add it to your main websites public directory.
This will allow it to be fetched from your website.
