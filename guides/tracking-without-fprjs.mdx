...
<Tip>
	If you use any other billing provider, you will need to track sales using the tracking API. For more information on sales tracking API, see documentation [here](/api-reference-v2/api-admin/tracking-api/leads-and-signups).
</Tip>
