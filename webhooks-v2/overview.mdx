...
Navigate to **Settings → Integrations → Webhooks v2** and click **Add subscription**, or manage subscriptions programmatically via the [Admin API](/api-reference-v2/api-admin/introduction).
...
<ResponseField name="secret_key" type="string">
  Auto-generated 64-character hex string used to sign payloads. See [Security](/webhooks-v2/security).
</ResponseField>
